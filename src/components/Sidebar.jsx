...
const menuItems = [
  ...
  },
  {
    ...
    icon: "\uD83D\uDCE6",
    modulo: "productos_proveedor",
  },
  {
    path: "/pedidos-cliente",
    label: "Pedidos Cliente",
    icon: "\uD83D\uDED2",
    modulo: "pedidos_cliente",
  },
  {
...
export default function Sidebar() {
  ...
  const visibleItems = menuItems.filter(
    (item) => getPermiso(item.modulo) !== "ninguno",
  );
  const allItems =
    user?.rol === "admin" ? [...visibleItems, ...adminItems] : visibleItems;
          ...
          return (
            <div
              ...
              style={{
                ...
                background: isActive
                  ? "linear-gradient(135deg, #2e7d6f, #3a9d8f)"
                  : "transparent",
                transition: "all 0.2s",
              }}
              onMouseEnter={(e) => {
                if (!isActive) e.currentTarget.style.background = "#e8f0e8";
              }}
              onMouseLeave={(e) => {
